...
* *ihMT_steadystate*: Included, see https://github.com/mriphysics/ihMT_steadystate for details.
* *tight_subplot*: Included.
...
# Folder organization:
* *fig1* to *figure4*, *fig_supp*: Figure generation codes.
